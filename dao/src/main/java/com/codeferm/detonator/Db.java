...
/**
 * Database access interface geared towards RDBMS. Implementations should handle bean mapping and converting snake_case field names
 * with underscores to camelCase.
 *
